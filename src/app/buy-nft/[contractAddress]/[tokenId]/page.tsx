...
export default function BuyNftPage() {
  ...
  const usdcAddress =
    (chainsToContracts[chainId]?.usdc as `0x${string}`) || "0x";
  ...
  const chainSupported =
    ...
    chainsToContracts[chainId]?.nftMarketplace !== undefined;
          ...
          {!address ? (
            ...
            <div className="p-8 bg-white rounded-xl shadow-sm border border-zinc-200 text-center">
              <p className="text-lg text-red-600 mb-4">
                The current network is not supported. Please switch to a
                supported network.
              </p>
              <div className="flex justify-center">
                <ConnectButton />
                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-2/3 space-y-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{tokenId}</p>
                      </div>
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  {isPurchaseSuccess ? (
                    <>
                      <div className="p-4 bg-green-50 text-green-700 rounded-md">
                        Congratulations! You have successfully purchased this
                        NFT. You will be redirected to the homepage in a few
                        seconds.
                      </div>
